...
public class LeftAngleTwoNote extends SequentialCommandGroup {
    public LeftAngleTwoNote(SwerveSubsystem swerve) {
        addCommands(
            ...
            new AutoAbsoluteDrive(swerve,0.0,0.0,-0.8,0.4).withTimeout(0.8), //angle for 2
